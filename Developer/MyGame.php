    ...
    <form id="form1" name="form1" method="post" action="">
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    <div class="row mt-2">
                        ...
                        <br>
                        <div class="row">
                            <div class="col-md-12" style=" padding-left: 135px;">
                                ...
                                <table style="color:#999;">
                                    <tr>
                                        ...
                                        <?php $ch = "select * from tbl_favourite where game_id = '" . $data['game_id'] . "' and  who = 'dev' and id = " . $_SESSION['did'];
                                        $ch1 = $conn->query($ch);
                                        if ($ch1->num_rows > 0) {
                                            $ch2 = $ch1->fetch_assoc(); ?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2" align="center"><a
                                        href="EditGame.php?edit=<?php echo $data['game_id'] ?>">EDIT DETAILS</a><br>
                                    <a href="ChangeLogo.php?edit=<?php echo $data['game_id'] ?>">CHANGE LOGO</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            if ($bet->num_rows > 0) {
                ...
                <h4 style="color: white; font-family: monospace;">
                    ...
                    <h3><a href="EditEvent.php?edit=<?php echo $hh['event_id'] ?>">Edit Event</a></h3>
                    <?php
            } else {
                ?>
                    <h3>NO EVENTS</h3>
        ...
        <script>
            ...
            function load_rating_data() {
                var game_id = $('#txt_gid').val();


                $.ajax({
                    url: "../Assets/AjaxPages/Ajaxviewrate.php",
                    method: "POST",
                    data: { action: 'load_data', gid: game_id },
                    dataType: "JSON",
                        ...
                        if (data.review_data.length > 0) {
                            ...
                            for (var count = 0; count < data.review_data.length; count++) {
                                ...
                                for (var star = 1; star <= 5; star++) {
                                    ...
                                    if (data.review_data[count].rating_data >= star) {
                                ...
                                html += data.review_data[count].rating;
...
if (isset($_POST['fav'])) {
    $who = "dev";
    $go = "select * from tbl_favourite where who = '$who'and id = $_SESSION[did] and game_id = $data[game_id]";
    $go1 = $conn->query($go);
    if ($go1->num_rows > 0) {
        $del = "delete from tbl_favourite where who = '$who' and id = $_SESSION[did] and game_id =$data[game_id]";
        ...
        $ins = "insert into tbl_favourite(who,id,game_id) values ('$who',$_SESSION[did],$data[game_id])";
