...
<body style="color: white;">
    <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
        <?php
        $show = "select * from tbl_dev where company_id = '$_GET[edit]'";
        $row = $conn->query($show);
        ...
        <div class="form-group row" style="align-items: center;">
            ...
            <div class="col-sm-10">
                ...
                <br>Current Logo <br>
                <img src="../Assets/Files/Developer/Logo/<?php echo $data['company_logo'] ?>" alt="currentlogo"
...
if (isset($_POST['submit'])) {
    ...
    if (empty($logo)) {
        ...
        $ch = "update tbl_dev set company_logo ='" . $logo . "' where company_id = " . $_GET['edit'];
