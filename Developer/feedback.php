            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="radio" id="feed" value="feedback" required>
                        <label class="form-check-label" for="feed">Feedback</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="radio" id="comp" value="complaint" required>
