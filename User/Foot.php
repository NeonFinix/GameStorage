            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="single_footer_part">
                        <h4>GameStorage</h4>
                        <p>
                            Games on the GameStorage platform aren't just entertainment; they're immersive journeys and
                            creative expressions that bring the gaming community together in a dynamic and diverse
                            virtual realm.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-sm-2 col-lg">
                    <div class="single_footer_part">
                        ...
                        <p>You can also contact us through <a href="feedback.php" class="footer_logo_iner">Here</a></p>
                        <!-- <h4>Newsletter</h4>
                    ...
                    <div class="copyright_text">
                        <P><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            ...
                            <script>document.write(new Date().getFullYear());</script> All rights reserved <i
                                class="ti-heart" aria-hidden="true"></i> to <a href="https://colorlib.com"
                                target="_blank">GameStorage</a>
