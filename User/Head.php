                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="blog.php">Write Blog</a>
                                            <a class="dropdown-item" href="BlogList.php">View Blogs</a>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <a href="MyProfile.php" class="btn_1 d-none d-sm-block">My Profile</a>
                        </nav>
                    </div>
                </div>
            </div>
