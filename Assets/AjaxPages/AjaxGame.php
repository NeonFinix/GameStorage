...
<div class="container">
    <div id="mydiv" class="mt-4">
        <div class="row">
            <?php
            $i = 0;
            $gel = "SELECT * FROM ((tbl_genre INNER JOIN tbl_games ON tbl_genre.genre_id = tbl_games.genre_id) INNER JOIN tbl_dev ON tbl_games.company_id = tbl_dev.company_id) where tbl_games.game_name LIKE '%$key%' and tbl_games.game_status = 1";
            ...
            while ($data = $gelect->fetch_assoc()) {
                ...
                <div class="col-md-3">
                        <div class="card h-100"> <!-- Add class "h-100" for card height -->
                            <a href="AgeCheck.php?kid=<?php echo $data['game_id'] ?>"><img
                            ...
                            <div class="card-footer">
                                <p class="text-center mb-0" style="color: #333">
                                    <a href="AgeCheck.php?kid=<?php echo $data['game_id'] ?>">
...
<div class="container">
    <div id="mydiv" class="mt-4">
        <div class="row">
            <?php
            $i = 0;
            $gel = "SELECT * FROM ((tbl_genre INNER JOIN tbl_games ON tbl_genre.genre_id = tbl_games.genre_id) INNER JOIN tbl_dev ON tbl_games.company_id = tbl_dev.company_id) where tbl_games.game_status = 1 and tbl_genre.genre_id = ".$GET['cid'];
            $gelect = $conn->query($gel);
            while ($data = $gelect->fetch_assoc()) {
                $i++;
                ?>
...
<div class="container">
    <div id="mydiv" class="mt-4">
        <div class="row">
            <?php
            $i = 0;
            $gel = "SELECT * FROM ((tbl_genre INNER JOIN tbl_games ON tbl_genre.genre_id = tbl_games.genre_id) INNER JOIN tbl_dev ON tbl_games.company_id = tbl_dev.company_id) where tbl_games.game_name LIKE '%$key%' and tbl_games.game_status = 1 and tbl_genre.genre_id = ".$_GET['cid'];
            $gelect = $conn->query($gel);
            while ($data = $gelect->fetch_assoc()) {
                $i++;
                ?>
