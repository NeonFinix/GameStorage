    ...
    <div class="container">
        ...
        <div id="mydiv" class="mt-4">
            <div class="row">
                <?php
                $i = 0;
                $gel = "SELECT * FROM ((tbl_genre INNER JOIN tbl_games ON tbl_genre.genre_id = tbl_games.genre_id) INNER JOIN tbl_dev ON tbl_games.company_id = tbl_dev.company_id) where tbl_games.genre_id = tbl_genre.genre_id";
...
<script>
    function searchGame(gid, cid) {
        $.ajax({
            url: "AjaxPages/AjaxGame.php?gid=" + gid + "&cid=" + cid,
