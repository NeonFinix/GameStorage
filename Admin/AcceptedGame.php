...
<head>
    ...
    <title>All Accepted Games</title>
</head>
<body>
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">All Accepted Games</h6>
                            ...
                            <?php
    $get = "select * from tbl_games gs inner join tbl_dev d on gs.company_id=d.company_id inner join tbl_genre gr on gs.genre_id=gr.genre_id";
    $row = $conn->query($get);
    $i = 1;
    ...
    ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td> <?php
                                                 $gg = "SELECT * FROM tbl_games WHERE game_status = 1 and game_id = ".$data['game_id'];
                                                    $gg1 = $conn->query($gg);
